...
% Transform y to a one-hot encoding
y_encoded = zeros(m, num_labels);
for i = 1:m
	y_encoded(i, y(i)) = 1;
end
y = y_encoded;

% Feedforward to compute predictions
a1 = [ones(m, 1) X];
z2 = a1 * Theta1';
...
% calculate deltas for each unit
delta3 = a3 - y;
...
% Compute regularized gradient for each parameter
